...
;
	($.$horrorgamelanding_subscribe) = class $horrorgamelanding_subscribe extends ($.$mol_card) {
		email_bid(){
			return "";
		}
		email(next){
		...
		Email_control(){
			...
			(obj.hint) = () => ((this.$.$mol_locale.text("$horrorgamelanding_subscribe_Email_control_hint")));
			(obj.value) = (next) => ((this.email(next)));
			return obj;
		}
		Email_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ((this.$.$mol_locale.text("$horrorgamelanding_subscribe_Email_field_name")));
		...
		Submit(){
			...
			(obj.title) = () => ((this.$.$mol_locale.text("$horrorgamelanding_subscribe_Submit_title")));
		...
		Form(){
			...
			(obj.body) = () => ([(this.Email_field())]);
			(obj.submit) = (next) => ((this.submit(next)));
			(obj.buttons) = () => ([(this.Submit()), (this.Message())]);
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$horrorgamelanding_subscribe_title"));
		}
		content(){
			return [(this.Form())];
		}
	};
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "email"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "Email_control"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "Email_field"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "submit"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "Submit"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "message"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "Message"));
	($mol_mem(($.$horrorgamelanding_subscribe.prototype), "Form"));
...
var $;
(function ($) {
    class $horrorgamelanding_email extends $hyoo_crus_entity.with({
    ...
    __decorate([
        $mol_mem
    ], $horrorgamelanding_email.prototype, "value", null);
    $.$horrorgamelanding_email = $horrorgamelanding_email;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $horrorgamelanding_domain extends $hyoo_crus_entity.with({
    ...
    __decorate([
        $mol_mem
    ], $horrorgamelanding_domain.prototype, "emails_list", null);
    __decorate([
        $mol_mem_key
    ], $horrorgamelanding_domain.prototype, "email", null);
    __decorate([
        $mol_mem
    ], $horrorgamelanding_domain.prototype, "emails", null);
    __decorate([
        $mol_mem_key
    ], $horrorgamelanding_domain.prototype, "email_public", null);
    __decorate([
        $mol_mem
    ], $horrorgamelanding_domain, "secure_public", null);
    __decorate([
        $mol_mem
    ], $horrorgamelanding_domain, "secure_private", null);
    $.$horrorgamelanding_domain = $horrorgamelanding_domain;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $horrorgamelanding_subscribe extends $.$horrorgamelanding_subscribe {
            domain() {
        ...
        __decorate([
            $mol_mem
        ], $horrorgamelanding_subscribe.prototype, "domain", null);
        __decorate([
            $mol_mem
        ], $horrorgamelanding_subscribe.prototype, "email_node", null);
        __decorate([
            $mol_mem
        ], $horrorgamelanding_subscribe.prototype, "email", null);
        __decorate([
            $mol_mem
        ], $horrorgamelanding_subscribe.prototype, "message", null);
        __decorate([
            $mol_mem
        ], $horrorgamelanding_subscribe.prototype, "submit", null);
        $$.$horrorgamelanding_subscribe = $horrorgamelanding_subscribe;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$horrorgamelanding_app) = class $horrorgamelanding_app extends ($.$mol_page) {
		Theme(){
		...
		Logo(){
			...
			(obj.uri) = () => ("horrorgamelanding/logo/logo.jpg");
			return obj;
		}
		Home(){
		...
		scroll_to_footer(next){
			if(next !== undefined) return next;
			return true;
		}
		Scroll(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Scroll to Footer");
			(obj.click) = (next) => ((this.scroll_to_footer(next)));
			return obj;
		}
		Subtitle(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Experience the terror like never before");
			return obj;
		}
		Hero(){
			const obj = new this.$.$mol_section();
			(obj.title) = () => ("Welcome to the Horror");
			(obj.sub) = () => ([(this.Subtitle())]);
			return obj;
		}
		Story_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Dive into a deep and terrifying narrative");
			return obj;
		}
		Story(){
			const obj = new this.$.$mol_card();
			(obj.title) = () => ("Immersive Story");
			(obj.sub) = () => ([(this.Story_text())]);
			return obj;
		}
		Graphics_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Next-gen visuals that will haunt your dreams");
			return obj;
		}
		Graphics(){
			const obj = new this.$.$mol_card();
			(obj.title) = () => ("Stunning Graphics");
			(obj.sub) = () => ([(this.Graphics_text())]);
			return obj;
		}
		Sound_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("3D audio that will make you look over your shoulder");
			return obj;
		}
		Sound(){
			const obj = new this.$.$mol_card();
			(obj.title) = () => ("Dynamic Sound");
			(obj.sub) = () => ([(this.Sound_text())]);
			return obj;
		}
		Features(){
			const obj = new this.$.$mol_list();
		...
		Subscribe(){
			const obj = new this.$.$horrorgamelanding_subscribe();
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$horrorgamelanding_app_title"));
		}
		plugins(){
			return [(this.Theme())];
		}
	...
	($mol_mem(($.$horrorgamelanding_app.prototype), "Theme"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Logo"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Home"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "About"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Contact"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Nav"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Lights"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "scroll_to_footer"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Scroll"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Subtitle"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Hero"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Story_text"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Story"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Graphics_text"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Graphics"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Sound_text"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Sound"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Features"));
	($mol_mem(($.$horrorgamelanding_app.prototype), "Subscribe"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $horrorgamelanding_app extends $.$horrorgamelanding_app {
            email(next) {
                return next ?? '';
            }
            Subscribe() {
        ...
        __decorate([
            $mol_mem
        ], $horrorgamelanding_app.prototype, "email", null);
        __decorate([
            $mol_mem
        ], $horrorgamelanding_app.prototype, "Subscribe", null);
        $$.$horrorgamelanding_app = $horrorgamelanding_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
